			...
			<div class="qbox">
				<div class="detailView">
					...
					<form action="insert.bo" method="post">
						...
						<input type="hidden" name="productNo" id=q_productNo value="">
						<table style="height: 200px;">
							...
							<tr>
								<td></td>
								<td style="width: 120px; height: 80%;" id="q_fileName"></td>
								<td colspan="2" style="width: 70px;" name="productName" id="q_productName"></td>
							</tr>
						</table>
						<hr>                                                                                                          
						<table>
				...
				success : function(list){
					...
					for(let i in list){
						result += "<tr >"
									...
									+ "<td><input type='hidden' name='productNo' value="+ list[i].productNo +"></td>"
								+ "</tr>";
					}
